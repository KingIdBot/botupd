/*
* LU MAU APA BRO
* AUTHOR BOT MhankBarBar, azizae, Fcx7,MrKing
* SUBSCRIBE CHANNEL MR KING
* TERCIDUK LU MAU GANTI OWNER DAN MEMBER PREMIUMNYA YA
* LU CARI APA BRO  ?
...
const { help } = require('./mrking/help')
const { rules } = require('./mrking/rules')
const { bahasa } = require('./mrking/bahasa')
const { donasi } = require('./mrking/donasi')
const { limits } = require('./mrking/limit')
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const MrKing = ["6285155441072@s.whatsapp.net"]
			const mrking = mek.message.conversation
